...
export function applyModel3_1Scaling() {
  ...
  const partsToRemove = moduleParts.filter((mesh) => {
    ...
    return name === 'top_mid3' || name === 'bottom_mid3' || name === 'horiz_beam4' || name === 'horiz_beam3' || name === 'horiz_beam2' || name === 'horiz_beam1';
  });
...
export function applyModel3_2Scaling(){
...
const partsToRemove = moduleParts.filter((mesh) => {
    const name = mesh.name.toLowerCase();
    return name === 'top_mid3' || name === 'bottom_mid3' || name === 'horiz_beam4' || name === 'horiz_beam2' ;
  });
...
export function applyModel3_3Scaling(){
